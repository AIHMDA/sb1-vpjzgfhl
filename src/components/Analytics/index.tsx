...
import { Eye, Download, Target, TrendingUp, Users, Clock, Search, Award } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="font-semibold text-gray-700">Rekruttører</h3>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="h-64 flex items-center justify-center border border-gray-100 rounded-lg">
            <p className="text-gray-500">Tidsgraf kommer snart</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <ul className="space-y-4">
            <li className="flex items-start gap-3">
              ...
              <div>
                <p className="text-gray-900 font-medium">CV blev vist af Novo Nordisk</p>
            ...
            <li className="flex items-start gap-3">
              ...
              <div>
                <p className="text-gray-900 font-medium">CV blev downloadet af COWI</p>
            ...
            <li className="flex items-start gap-3">
              ...
              <div>
                <p className="text-gray-900 font-medium">Match med Senior Engineer stilling</p>
                <p className="text-sm text-gray-500">I går, 09:15</p>
              </div>
            </li>
          </ul>
        </div>
