...
import { Moon, Sun, Globe, Bell, Shield, User, FileText, Palette, Layout } from 'lucide-react';
    ...
    <div className="max-w-4xl space-y-8">
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-800">Farvetema</p>
                    <p className="text-sm text-gray-500">Tilpas farver til din stil</p>
                  </div>
                </div>
                <select className="px-3 py-2 rounded-lg border border-gray-200 bg-white">
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-800">CV Layout</p>
                    <p className="text-sm text-gray-500">Vælg dit foretrukne CV layout</p>
                  </div>
                </div>
                <select className="px-3 py-2 rounded-lg border border-gray-200 bg-white">
                  <option value="modern">Moderne</option>
          ...
          {/* Export Settings */}
          <section>
            <h3 className="text-lg font-semibold text-gray-700 mb-4">Eksport</h3>
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div className="flex items-center gap-3">
                  <FileText className="w-5 h-5 text-gray-600" />
                  <div>
                    <p className="font-medium text-gray-800">Standard Format</p>
                    <p className="text-sm text-gray-500">Vælg standard eksportformat</p>
                  </div>
                </div>
                <select className="px-3 py-2 rounded-lg border border-gray-200 bg-white">
